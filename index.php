<!doctype html> <html lang="fr"> <meta charset="utf-8"> <form method="post" action="">
  <div class="row">
  ...
  </div> </form> <?php if(isset($_POST) && !empty($_POST['nom']) && !empty($_POST['prenom']) && !empty($_POST['objet']) && !empty($_POST['email']) && !empty($_POST['message'])) {
  ...
  ;
  $mail = mail($destinataire, "Nouveau message de news.pomset.fr", $message, $expediteur, $header); if($mail) echo $succes; else echo $echec;
}
?>
</html>
